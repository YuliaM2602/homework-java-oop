...
import ru.geekbrains.homework.block.ContentNavigationCourseBlock;
...
public class CoursePage extends ContentPage {
    ...
    public ru.geekbrains.homework.page.CoursePage configFilter(String... args) {
    ...
    //TODO Step
    public ru.geekbrains.homework.page.CoursePage checkingDisplayedCourses(String... args) {
        for (String test : args) {
    ...
    @Override
    public ru.geekbrains.homework.page.CoursePage openUrl() {
